...
class AppRoutes {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: chef_verify_user, page: () =>  const ChefVerifyUser()),
    GetPage(name: splash, page: () => const SplashScreen()),
    GetPage(name: onboarding, page: () => const OnboardingScreen()),
    GetPage(name: signUp, page: () => SignUpScreen()),
    GetPage(name: chefUpdateLocationScreen, page: () => const ChefUpdateLocationScreen()),
    ...
    GetPage(name: homeSearch, page: () => const SearchScreen()),
    GetPage(name: chefDetails, page: () => const ChefDetailsScreen()),
    GetPage(name: cart, page: () => const CartScreen()),
    GetPage(name: checkout, page: () => const CheckoutScreen()),
    GetPage(name: businessTaxDetails, page: () => const BusinessTaxDetailsScreen()),
    GetPage(name: personalTaxDetails, page: () => const PersonalTaxDetailsScreen()),
    GetPage(name: requestChange, page: () => RequestChangeScreen()),
    GetPage(name: App_Information_Screen, page: () => const AppInformationScreen()),
    GetPage(name: edit_address, page: () => const EditAddressScreen()),
    GetPage(name: addressScreen, page: () => const ProfileAddressScreen()),
    ...
    GetPage(name: pastOrder, page: () => const PastOrderScreen()),
    GetPage(name: reorder, page: () => ReorderScreen()),
    GetPage(name: review, page: () => const ReviewScreen()),
    GetPage(name: chefHomeScreen, page: () => const ChefHome()),
    GetPage(name: chefBooking, page: () => const ChefBookingScreen()),
    GetPage(name: chefProfile, page: () => const ChefProfileScreen()),
    GetPage(name: chefPublicProfile, page: () => const ChefPublicProfile()),
    GetPage(name: chefEditProfile, page: () => const ChefEditProfile()),
    GetPage(name: availability, page: () => const AvailabiityScreen ()),
    GetPage(name: menu, page: () => const MenuScreen()),
    GetPage(name: addMenu, page: () => const AddMenuScreen()),
    GetPage(name: editMenu, page: () => const EditMenu()),
    GetPage(name: accountSetting, page: () => const AccountSetting()),
    GetPage(name: kitchen, page: () => const KitchenScreen()),
    GetPage(name: dietary, page: () => const DietaryScreen()),
    GetPage(name: addEquipment, page: () => const AddEquipmentScreen()),
    GetPage(name: chefPayment, page: () => const ChefPaymentScreen()),
    GetPage(name: addPaymentMethod, page: () => const AddPaymentMethod()),
    GetPage(name: withdraw, page: () => const WithdrawScreen()),
    GetPage(name: withdrawMethod, page: () => const WithdrawMethodScreen()),
