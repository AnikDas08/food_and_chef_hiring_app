            ...
            body: SafeArea(
              child: Stack(
                children: [
                  Stack(
                    children: [
                      const CommonImage(imageSrc: AppImages.image3),
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: Get.back,
                          child: const CommonImage(imageSrc: AppIcons.back),
                        ),
                      ),
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          ...
                          child: const CommonImage(imageSrc: AppIcons.chef),
                        ),
                      ),
                    ],
                  ),
