...
class AddMenuScreen extends StatelessWidget {
          ...
          content: Column(
            ...
            children: [
              ...
              Obx(() {
                ...
                final units =
                c.unitsList.isEmpty ? ["kg", "g", "ml", "l"] : c.unitsList;
        ...
        builder: (context) => Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: hint,
              hintStyle: TextStyle(
                  fontSize: 13.sp, color: const Color(0xFFBBBBBB)),
            ),
          ),
        ));
  }
  ...
  Widget _textField(TextEditingController ctrl, String hint) => Container(
    ...
    child: TextField(
      controller: ctrl,
      style:
      TextStyle(fontSize: 13.sp, color: const Color(0xFF272727)),
      decoration: InputDecoration(
        border: InputBorder.none,
        contentPadding:
