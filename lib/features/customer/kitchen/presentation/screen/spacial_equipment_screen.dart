...
import 'package:new_untitled/features/customer/kitchen/presentation/screen/upload_photo_screen.dart';
...
class SpecialEquipmentScreen extends StatelessWidget {
  ...
  static const String _category = 'Special Equipment';
          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8.h),
                  CommonText(
                    text: 'Do you have any special equipment? These unlock more advanced recipes.',
                    fontSize: 13,
            ...
            Expanded(
              child: Obx(() {
                ...
                if (items.isEmpty) {
                  return Center(
                    child: CommonText(text: 'No special equipment found.', fontSize: 13, color: const Color(0xFF888888)),
                  );
                }
                ...
                children: [
                  RichText(
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                        text: ' (optional)',
                        style: TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w400, color: const Color(0xFF888888)),
                      ),
                    ]),
                  ),
                  Row(
